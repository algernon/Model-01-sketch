...
const Key keymaps[][ROWS][COLS] PROGMEM = {
  ...
  (___,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_F18,
   ...
   Key_LEDEffectNext,  Key_6, Key_7, Key_8,     Key_9,         Key_0,         Key_KeypadNumLock,
...
void setup() {
  ...
  static kaleidoscope::SpaceCadet::KeyBinding spacecadetmap[] = {
    {Key_LeftShift, Key_LeftParen, 150}
    , {Key_RightShift, Key_RightParen, 150}
    , SPACECADET_MAP_END
  };
  //Set the map.
